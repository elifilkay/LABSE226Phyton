...
while num1 < 1 or num1 > 999:
    num1 = int(input("Invalid input! Please enter a number between 1-999 (inclusive) for the first number: "))

num2 = int(input("Enter the second number between 1-999 (inclusive): "))
while num2 < 1 or num2 > 999 or num2 >= num1:
    num2 = int(input("Invalid input! Please enter a number between 1-999 (inclusive) and less than the first number for the second number: "))
...
words = ["a", "ability", "able", "about", "above", "accept", "according", "account", "across", "act", "action",
             ...
             "yourself"]
slice_words=words[num2:num1]
print(slice_words)

#Lab4-2
import random
user_number = int(input("Enter a number between 3 and 7 to choose the number of words for the password: "))
while user_number < 3 or user_number > 7:
    user_number = int(input("Invalid input! Please enter a number between 3 and 7 for the number of words: "))

# Randomly choose the specified number of words from the list
...
for i in range(8):
    user_number = int(input("Enter a number between 3 and 7 for password: "))
    while user_number < 3 or user_number > 7:
        user_number = int(input("Invalid input! Please enter a number between 3 and 7 for the number of words: "))
...
# Combine the shorter and longer sets
